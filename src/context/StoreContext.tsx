...
export function StoreProvider({ children }: { children: ReactNode }) {
  ...
  const clearCart = async () => {
    setCartItems([]);
    await updateStoreInFirebase([], wishlistItems);
  };

  return (
    <StoreContext.Provider value={{ cartItems, wishlistItems, addToCart, updateCartQuantity, removeFromCart, toggleWishlist, isInWishlist, clearCart }}>
      {children}
