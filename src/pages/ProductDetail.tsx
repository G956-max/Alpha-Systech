...
export default function ProductDetail() {
    ...
    const fetchProduct = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          // Fallback mock data if not in Firebase
          ...
          if (mockProduct) {
            setProduct({
              ...
              description: `Experience uncompromising performance with the ${mockProduct.name}. Designed for professionals who demand excellence, featuring premium build quality, advanced cooling, and next-generation specifications.`,
              ...
              options: {
                name: 'Configuration',
                values: ['Standard Base', 'Performance Tier', 'Ultimate Tier']
              }
            });
            setSelectedOption('Standard Base');
          } else {
            setProduct({
              id: 'mock-1',
              name: 'Alpha Workstation Pro',
              price: 2499,
              category: 'Workstations',
              description: 'Our flagship enterprise machine engineered for the most demanding computational tasks and rendering workflows.',
              ...
              options: {
                name: 'Configuration',
                values: ['32GB RAM / 1TB SSD', '64GB RAM / 2TB SSD']
              }
            });
            setSelectedOption('32GB RAM / 1TB SSD');
          }
        }
      } catch (error) {
  ...
  const handleShare = async () => {
    const shareData = {
      title: product?.name,
      text: `Check out this ${product?.name} on ALPHA SYSTECH!`,
