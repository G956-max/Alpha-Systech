...
export default function AdminAddProduct() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const catNames = querySnapshot.docs.map(doc => doc.data().name);
        setAvailableCategories(catNames as string[]);
      } catch (err) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (form.specs) productData.specs = form.specs;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-4">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1">Product Model / Title</label>
              <input 
                type="text" 
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-8 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#1a202c]/10 outline-none"
                  />
                </div>
              </div>
              <div>
